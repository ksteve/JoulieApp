...
import com.example.kyle.joulieapp.DevicesUsageViewHolder;
import com.example.kyle.joulieapp.R;
import com.example.kyle.joulieapp.TrendsViewHolder;
...
import com.example.kyle.joulieapp.UsageSummaryViewHolder;
 ...
 */
public class UsageRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public UsageRecyclerViewAdapter(List<Usage> items, OnListFragmentInteractionListener listener) {
